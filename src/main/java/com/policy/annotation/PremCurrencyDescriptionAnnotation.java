...
import com.policy.validator.branchCodeValidator;
	...
	@Documented
	@Constraint(validatedBy = PremCurrencyDescriptionValidator.class)
	public @interface PremCurrencyDescriptionAnnotation {
		public String message() default "premCurrencyDescription must not be null";
