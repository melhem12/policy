...
import com.policy.validator.SICurrencyExchangeRateValidator;
...
import com.policy.validator.branchCodeValidator;
	...
	@Documented
	@Constraint(validatedBy = SICurrencyExchangeRateValidator.class)
	public @interface SICurrencyExchangeRateAnnotation {
		public String message() default "SICurrencyExchangeRate must not be null";
